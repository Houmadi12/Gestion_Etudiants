...
let btnCherche = document.querySelector("#inputFilter")
...
btnCherche.addEventListener("input", filterEtudiants);
// Affichage
AfficheCard();
...
// fonction filter
function filterEtudiants(e) {

    const searchString = e.target.value.toLowerCase();

    let filterData = etudians.filter(el => el.prenom.toLowerCase().includes(searchString));

    AfficheEtudiants(filterData);
}
